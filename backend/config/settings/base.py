"""
Django settings for Sloth AI Agent platform.
"""
import os
...
# Database
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgresql://sloth:sloth@localhost:5432/sloth')
}
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@sloth.com')
